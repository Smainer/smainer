...
argument-hint: "Envelope type needed: task_brief | task_manifest | delivery_report | validation_report | meeting_contribution | meeting_minutes"
...
Full topology and call rules: see `.github/PIPELINE_TOPOLOGY.md`.
...
**Note**: `domain_requirements` should explain the *why* behind constraints, not just state them.

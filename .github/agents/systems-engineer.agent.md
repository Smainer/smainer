---
title: "systems-engineer (Copilot)"
...
- Default workflow: read the SSH password from workspace root `paas.txt`, then continue the existing terminal session without echoing or storing the password.

...
3. **Critical Dependencies**: Cross-team handoffs and external dependencies
...
- DO NOT set unrealistic deadlines — align with 1-2 week sprint cycles
- ONLY focus on post-engineering GTM activities — assume technical implementation is handled separately
- DO NOT create plans without defining clear owners and sprint deadlines
